...
import { TabContent, TabPane, Nav, NavItem, NavLink, Button, Input, Label, Table, CustomInput, CardHeader, CardTitle, FormattedMessage, UncontrolledDropdown, DropdownToggle, DropdownMenu, DropdownItem} from 'reactstrap'
import {  Printer, ExternalLink, Download, RefreshCw, RotateCw, Plus, MoreVertical, Edit2, CheckCircle, XCircle, EyeOff, CornerUpLeft} from 'react-feather'
          ...
          <TabContent className='py-50' activeTab={active}>
            ...
            <Row className="ml-0 mb-3">
                <Col className='justify-content-start mt-1' md="4" sm="12">
                    ...
                    <Input className="input-table2" type='text' value="Animal Health Division" />
                </Col>
                <Col className='justify-content-start mt-1' md="4" sm="12">
