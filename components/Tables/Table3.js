...
import { TabContent, TabPane, Nav, NavItem, NavLink, Button, Input, Label, Table, CustomInput } from 'reactstrap'
                  ...
                  <Card className="pt-2" style={{border:"1px solid #d8d6de"}}>
                    <Card>
                      <Row className="mx-0 ml-0 mb-2">
                        <Col className="d-flex align-items-center justify-content-start" md="8">
                          <h5 className="font-weight-bolder ml-3 mr-3 mt-1" style={{marginRight:"610px !important"}}> Table Title</h5>
                        </Col>
                        <Col className='d-flex align-items-center justify-content-end mt-1' md='1' sm='12'>
                          <Label className='mr-1' for='search-input-1'>
                              Show
                          </Label>
                          <CustomInput
